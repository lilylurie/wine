...
for i in range(16,100):
    try:
        ...
        print(len(set(dataframe["Wine ID"].tolist())))
        ratings = []
        ...
        page += 1
            ...
            ratings = pd.DataFrame(
                ratings, columns=["Year", "Wine ID", "User's Grade", "Note", "CreatedAt", "user id", "followers", "following",
                                  "User Ratings", "language"]
            )

            df_out = dataframe.merge(ratings)
            string = "wine_" + str(i) + ".csv"
